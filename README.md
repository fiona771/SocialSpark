...
The design of the **[SocialSpark]** was based on the following key considerations:
...
1. **Challenge 1**: [setting up github actions for the first time"]
   - **Solution**: [i follewd my lectures guide and learned how to create workflow files to automate the build process."]
   
2. **Challenge 2**: [connecting andriod studio to github"]
   - **Solution**: [i used the git menu in android studio to commit and push my code to the remote repositary]
...
1. **Feature 1**: [allowing users to set up daily reminders for social activities"]
2. **Feature 2**: [integrating with a cloud database to save user preferences."]
3. **Feature 3**: [adding a dark mode option for better user experince."]

---

## References

1. [Reference 1: android developers. (2024). android basics. at: https://developer.android.com.]
2. [Reference 2: kotlin documentation. (2024). kotlin programming language. at: https://koylinlang.org.]
